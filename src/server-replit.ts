...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`📱 Frontend: https://${process.env.REPL_SLUG}.${process.env.REPL_OWNER}.repl.co`);
  console.log(`🔧 API: https://${process.env.REPL_SLUG}.${process.env.REPL_OWNER}.repl.co/api`);
  console.log(`💚 Health: https://${process.env.REPL_SLUG}.${process.env.REPL_OWNER}.repl.co/health`);
});